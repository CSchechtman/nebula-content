...
const greetingPart = greeting.slice(6, 12)
console.log(greetingPart)
...
const savedTemplateLiteral = `My ${word15} thing to ${word13} ${word20} ${word9} ${word21} ${word22} ${word8}.`
console.log(savedTemplateLiteral)

// 4. Given the string of your full name get your initials.
const fullName = 'Craig Schechtman'
const craigInitials = fullName.slice(0, 1) + fullName.slice(6, 7)
console.log(craigInitials)
...
const splitSentence1ToArr = sentence1.split("-")
console.log(splitSentence1ToArr)

// 10. Make the string of 12 from the following two numbers:
let one = 1;
let two = 2;
console.log(one + (two).toString())
